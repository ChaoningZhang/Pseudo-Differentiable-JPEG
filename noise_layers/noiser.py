...
from noise_layers.combined2 import Combined2
...
class Noiser(nn.Module):
    ...
    """
    def __init__(self, noise_layers: list, device, jpeg_type):
        ...
        for layer in noise_layers:
            if type(layer) is str:
                ...
                elif layer == 'Combined2Placeholder':
                    self.noise_layers.append(Combined2(device, jpeg_type))
                else:
