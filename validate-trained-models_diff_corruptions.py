...
def main():
    ...
    with torch.no_grad():
        noises = ['jpeg_10', 'jpeg_25', 'jpeg_50', 'jpeg_75', 'jpeg_90',
                  'jpeg2000_100', 'jpeg2000_250', 'jpeg2000_500', 'jpeg2000_750', 'jpeg2000_900',
                  'webp_10', 'webp_25', 'webp_50', 'webp_75', 'webp_90']
        for noise in noises:
            losses_accu = {}
            step = 0
            ...
            # utils.print_progress(losses_accu)
            write_validation_loss(os.path.join(args.runs_root, 'validation_run.csv'), losses_accu, noise,
                                checkpoint['epoch'],
