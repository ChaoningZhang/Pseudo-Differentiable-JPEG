...
class Hidden:
    ...
    def validate_on_batch_specific_noise(self, batch: list, noise='identity'):
        """
        Runs validation on a single batch of data consisting of images and messages
        :param batch: batch of validation data, in form [images, messages]
        :return: dictionary of error metrics from Encoder, Decoder, and Discriminator on the current batch
        ...
        with torch.no_grad():
            ...
            encoded_images, noised_images, decoded_messages = self.encoder_decoder.forward_specific_noiser(images, messages, noiser=noise)
